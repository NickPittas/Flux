...
- T081: 🔎 Text Animator finishing touches — implementation/build passed; GUI validation pending. Preserves target values during shape/keyframe workflow, adds selectable transform anchor dropdown, adds sliders for Scale/Start/End/Offset/Strength, and selecting animator rows opens/highlights the Animator panel.
...
- Text Animator finishing touches from Nick's 2026-05-26 acceptance: value preservation during keyframe/shape changes, selectable animator transform anchor, sliders for main animator numeric controls, and animator-row selection opening/highlighting in the Animator panel.
