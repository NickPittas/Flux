...
- T083: 🟡 IN_PROGRESS — AI matte/mask generation and video depth tools. Detailed plan: `tasks/T083-ai-matte-depth.md`. Approved direction: CUDA-first external Python worker, AI panel plus nodegraph nodes, viewer selection, project-relative generated raster media, secure no-plaintext-token model manager, SAM3.1 user-downloadable, MatAnyone2/DepthCrafter non-commercial warnings, RVM/XMem2 external helper hooks, and Force Save As before AI generation in unsaved projects.
