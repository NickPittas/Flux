...
const char* vertRGBModern =
    ...
    "{\n"
    "   vTexCoord = texCoord;\n"
    "   gl_Position = projectionMatrix * vec4(vertexCoord.xy, 0.0, 1.0);\n"
    "}\n"
;
const char* fragRGBModern =
    "#version 150\n"
    "uniform sampler2D Tex;\n"
    "uniform float gain;\n"
    "uniform float offset;\n"
    ...
    "void main() {\n"
    "   vec4 color_tmp = texture(Tex, vTexCoord);\n"
    "   color_tmp.rgb = (color_tmp.rgb * gain) + offset;\n"
    "   if (lut == 0) {\n"
    "       color_tmp.r = linear_to_srgb(color_tmp.r);\n"
    "       color_tmp.g = linear_to_srgb(color_tmp.g);\n"
