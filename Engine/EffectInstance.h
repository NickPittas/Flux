...
#define PLUGINID_NATRON_AIPAINT (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.AIPaint")
...
#define PLUGINID_NATRON_ROTO_REPLACE_CHANNELS (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.RotoReplaceChannels")
#define PLUGINID_FLUX_AI_MASK_COPY (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.FluxAIMaskCopy")
#define PLUGINID_FLUX_CHANNEL_MERGE (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.FluxChannelMerge")
#define PLUGINID_FLUX_CORRIDOR_KEY (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.FluxCorridorKey")
